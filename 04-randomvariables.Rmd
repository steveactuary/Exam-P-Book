...
***
```{definition, name="Probability Distribution Function"}
The probability distribution calculates $P(X=x)$. There is a special way to write this, instead of using a capital $P$ we use a lowercase $p$ and say that:
$$p(x)=P(X = x)$$
